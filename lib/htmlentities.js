...
const entities = [
  // XXX don't decode these signs
	...
	{"value":"ў", code : "&ubrcy;", hex : "&#1118;", desc : ""},
	{"value":"џ", code : "&dzcy;", hex : "&#1119;", desc : ""},
	{"value":"[", escaped_value: "\\[", code : "&lsqb;", hex : "&#91;", desc : ""},
	{"value":"\\", escaped_value: "\\\\", code : "&bsol;", hex : "&#92;", desc : ""},
...
module.exports = {
	...
	encode : (text) => {
		for (var i = 0, max = entities.length; i < max; ++i)
	        text = text.replace(new RegExp(entities[i].escaped_value||entities[i].value, 'g'), entities[i].code);
	    return text;
	},
	decodeLG : (text) => {
